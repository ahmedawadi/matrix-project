        ...
        if(!validFormData){
            ...
            axios.post(process.env.backendDomainName + "/matrix/send-email/", feedbackInfo).then(res => {
                ...
                if(error?.response?.status == 400 && error?.response?.data?.message)
                    ...
                    submitionWarning.innerHTML = content.warnings.tryAgain
                        ...
                        <div className='xl:text-[22px] pt-[16px] px-[20px] flex flex-col items-center space-y-[16px]'>
                            <div className="md:w-[70%] w-[95%] flex space-x-[10px]">
                                <div className="flex flex-col basis-[50%] overflow-hidden">
                                    <input id="firstName" className=" p-[5px] bg-transparent border-[3px] border-[#E4E7EA] outline-none" placeholder={content.firstName} />
                                    <div id="firstNameWarning" className="text-[#c70024] text-[15px]"></div>
                                </div>
                                <div className="flex flex-col basis-[50%] overflow-hidden">
                                    <input id="lastName" className=" h-fit p-[5px] bg-transparent border-[3px] border-[#E4E7EA] outline-none" placeholder={content.lastName} />
                            ...
                            <div className="flex flex-col md:w-[70%] w-[95%]">
                                <textarea id="feedback" className="w-full p-[5px] bg-transparent border-[3px] border-[#E4E7EA] min-h-[70px] outline-none" placeholder={content.comment}></textarea>
