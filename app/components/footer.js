    ...
    <div className="w-full flex flex-col bg-[#424143]">
      <div className="w-full h-full flex lg:flex-row flex-col lg:space-y-0 space-y-[25px]  xl:px-[30px] px-[20px] py-[20px] text-[#E4E7EA]">
            ...
            <div className="basis-1/3">
              <div className="flex flex-col space-y-[30px]">
                <label className="flex flex-col space-y-[4px]">
                  <div
                    className="font-semibold lg:text-[16px] text-[20px] flex justify-between lg:cursor-auto cursor-pointer"
                    onClick={() => seeOrHideLink(0)}
                  >
                    {footerElements.frontEndDev}
                    <div id="plusIcon0" className="lg:hidden">
                      +
                    </div>
                  </div>
                  <div
                    id="linkInfo0"
                    className="lg:flex space-x-[10px] items-center pl-[15px] hidden"
                  >
                    <div className="text-[14px]">ahmed awadi</div>
                    <div className="cursor-pointer flex space-x-[10px]">
                      <a
                        className="w-[20px] h-[20px]"
                        target="_blank"
                        href="https://www.linkedin.com/in/awedi-ahmed-020152245/"
                      >
                      ...
                      <a
                        className="w-[20px] h-[20px]"
                        target="_blank"
                        href="https://github.com/ahmedawadi"
                      >
                ...
                <label className="flex flex-col space-y-[4px]">
                  <div
                    className="font-semibold lg:text-[16px] text-[20px] flex justify-between lg:cursor-auto cursor-pointer"
                    onClick={() => seeOrHideLink(1)}
                  >
                    {footerElements.backEndDev}
                    <div id="plusIcon1" className="lg:hidden">
                      +
                    </div>
                  </div>
                  <div
                    id="linkInfo1"
                    className="lg:flex space-x-[5px] items-center pl-[15px] lg:inline-block hidden"
                  >
                    <div className="text-[14px]">mohamed awadi</div>
                    <div className="cursor-pointer flex space-x-[10px]">
                      <a
                        className="w-[20px] h-[20px]"
                        href="https://www.linkedin.com/in/mmaouedi/"
                        target="_blank"
                      >
                        <FontAwesomeIcon icon={faLinkedin} size="lg" />
                      </a>
            ...
            <div className="basis-1/3">
              <div className="flex flex-col space-y-[30px]">
                <label className="flex flex-col space-y-[4px]">
                  <div
                    className="font-semibold lg:text-[16px] text-[20px] flex justify-between lg:cursor-auto cursor-pointer"
                    onClick={() => seeOrHideLink(2)}
                  >
                    {footerElements.uiux}
                    <div id="plusIcon2" className="lg:hidden">
                      +
                    </div>
                  </div>
                  <div
                    ...
                    className="lg:flex space-x-[5px] items-center pl-[15px] lg:inline-block hidden"
                  >
                    <div className="text-[14px]">soulaima bouhachem</div>
                    <div className="cursor-pointer ">
                      <a
                        className="w-[20px] h-[20px]"
                        href="https://www.linkedin.com/in/soulaima-bouhachem-76583420b/"
                        target="_blank"
                      >
                        <FontAwesomeIcon icon={faLinkedin} size="lg" />
                      </a>
                ...
                <label className="flex flex-col space-y-[4px]">
                  <div
                    className="font-semibold lg:text-[16px] text-[20px] flex justify-between lg:cursor-auto cursor-pointer"
                    onClick={() => seeOrHideLink(3)}
                  >
                    {footerElements.algorithmDev}
                    <div id="plusIcon3" className="lg:hidden">
                      +
                    </div>
                  </div>
                  <div
                    ...
                    className="lg:flex space-x-[5px] items-center pl-[15px] lg:inline-block hidden"
                  >
                    <div className="text-[14px]">amal moussa</div>
                    <div className="cursor-pointer ">
                      <a
                        className="w-[20px] h-[20px]"
                        href="https://www.linkedin.com/in/amal-moussa-35b834252/"
                        target="_blank"
                      >
                        <FontAwesomeIcon icon={faLinkedin} size="lg" />
                      </a>
            ...
            <div className="basis-1/3">
              <div className="flex flex-col space-y-[30px]">
                <label className="flex flex-col space-y-[4px] lg:w-fit w-full">
                  <div
                    className="font-semibold lg:text-[16px] text-[20px] flex justify-between lg:cursor-auto cursor-pointer"
                    onClick={() => seeOrHideLink(4)}
                  >
                    {footerElements.gitLink}
                    <div id="plusIcon4" className="lg:hidden">
                      +
                    </div>
                  </div>
                  <a
                    id="linkInfo4"
                    href="https://github.com/ahmedawadi/matrix-project-full-stack"
                    target="_blank"
                    className="lg:flex space-x-[5px] items-center pl-[15px] lg:inline-block hidden"
                  >
                    <div className="text-[14px]">Website code</div>
                ...
                <label className="flex flex-col space-y-[4px]">
                  <div
                    className="font-semibold lg:text-[16px] text-[20px] flex justify-between lg:cursor-auto cursor-pointer"
                    onClick={() => seeOrHideLink(5)}
                  >
                    {footerElements.supervisor}
                    <div id="plusIcon5" className="lg:hidden">
                      +
                    </div>
                  </div>
                  <div
                    ...
                    className="lg:flex space-x-[5px] items-center pl-[15px] lg:inline-block hidden"
                  >
                    <div className="text-[14px]">Dr. Sirirne Marrakchi</div>
                    <div className="cursor-pointer ">
                      <a
                        className="w-[20px] h-[20px]"
        ...
        <div className="lg:basis-[15%] lg:pl-0 pl-[5px] flex items-end lg:justify-end justify-end [#E4E7EA]space-nowrap lg:text-[40px] text-[30px] font-black  font-serif">
          <div className="w-fit opacity-80 hover:opacity-100">
            <div className="calculTitle">{footerElements.title.first}</div>
      ...
      <div className="bg-[#383838] w-full h-full flex justify-center px-[30px] py-[5px] text-white md:text-[15px] text-[10px]">
        <a href="https://fss.rnu.tn/" className="flex items-center">
          ...
          />
          <div className="font-thin text-[14px]">{footerElements.faculty}</div>
        </a>
      </div>
    </div>
  );
...
function seeOrHideLink(linkId) {
  ...
  if (link.classList.contains("hidden")) {
    //user wanna see the info
    link.classList.remove("hidden");
    icon.innerHTML = "-";
  } else {
    //user wanna hide the info
